...
public class BuildMenu extends javax.swing.JFrame implements MouseListener {
    ...
    private ImageIcon threeTile;//triabva da se dobavyat 4-tile i 5-tile korabi
...
// </editor-fold>
        ...
        staticShipLabels.elementGetter(2).setBounds(800, 400, 140, 48);//tryabva da se naglasi spryamo pristanishteto
        staticShipLabels.elementGetter(2).addMouseListener(new MouseAdapterForShipSpawning());
// </editor-fold>

        //triabva da se dobavyat 4-tile i 5-tile korabi
