...
public class EndScreen extends javax.swing.JFrame {
    ...
    public EndScreen(Player winner, Player loser) {
        ...
        txtNamePlayer1.setFont(new Font("Fira Sans", Font.BOLD, 15));
        // </editor-fold>
        ...
        txtNamePlayer2.setFont(new Font("Fira Sans", Font.BOLD, 15));
        // </editor-fold>
        ...
        txtAccuracyPlayer1.setBounds(333, 235, 100, 30);
        txtAccuracyPlayer1.setText(findAccuracy(loser) + "%");
        ...
        txtAccuracyPlayer2.setBounds(490, 235, 100, 30);
        txtAccuracyPlayer2.setText(findAccuracy(winner) + "%");
        ...
        quitButton.setBounds(242, 620, 188, 83);
        ...
        scoreboard.setBounds(365, 340, 300, 300);
    ...
    private void scoreboardDisplayer() throws FileNotFoundException {
        ...
        try {
            ...
            out.write(winner.getName() + "   " + scoreCaluclator(loser) + "\n");
            out.close();
    ...
    private int scoreCaluclator(Player player) {
        int score = 0;
        score = (findAccuracy(player) * 100) / StrikeMenu.getRounds();
        return score;
    }
}
